...
if __name__ == '__main__':
    ...
    modelState_fpath = f"/home/max/PycharmProjects/cifar10_both_gpu_and_cpu/state/cifar10_{train_on_device}_net.pth"
    if what_to_do == 'test':
    ...
    if what_to_do == 'train':
        train_nn_model(train_on_device, trainset, batch_size, nu_channels, modelState_fpath, device)
    elif what_to_do == 'test':
